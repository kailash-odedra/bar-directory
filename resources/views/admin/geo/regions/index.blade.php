        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area mt-3">
                <div class="d-flex justify-content-between align-items-center mt-3">
                    ...
                    <a href="{{ route('admin.regions.create') }}" class="btn btn-primary">Add New Region</a>
                </div>
                ...
                <table id="html5-extension" class="table dt-table-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $region->city->state->country->name ?? '-' }}</td>
                            <td>{{ $region->slug }}</td>
                            <td>
                                <button type="button" 
                                    class="btn btn-sm toggle-status-btn {{ $region->is_active == 1 ? 'btn-success' : 'btn-danger' }}" 
                                    data-id="{{ $region->id }}">
