...
document.addEventListener("DOMContentLoaded", function() {
    // Only run themeToggle if button exists
    const btn = document.querySelector("#theme-toggle");
    if (btn && typeof themeToggle === "function") themeToggle();

    // Wrap init to prevent JS crash
    if (typeof init === "function") {
        try {
            init();
        } catch (e) {
            console.warn("init skipped due to error", e);
        }
    }
});
</script>
