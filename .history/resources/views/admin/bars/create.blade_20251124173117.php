                        ...
                        <div class="col-12 mt-4">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach($days as $i => $d)
                                        @php
                                            $t = isset($bar) ? $bar->timings->where('day',$d)->first() : null;
                                        @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="time" name="open_time[]" class="form-control"
                                                value="{{ $t->open_time ?? '' }}"></td>

                                            <td><input type="time" name="close_time[]" class="form-control"
                                                value="{{ $t->close_time ?? '' }}"></td>

                                            <td class="text-center">
                                                <input type="checkbox" name="is_closed[{{ $i }}]"
