...
@endif
@if (request()->is('admin/bar/create') || request()->is('admin/bar')) 
    {{-- Only include or run theme JS on create or home pages --}}
    <script src="path/to/app-BsoO1i2u.js"></script>
@endif
@section('styles')
{{-- Style Here --}}
...
@section('scripts')
<script>
  // Override the themeToggle function to an empty function to prevent error on edit page
  if (window.themeToggle) {
    window.themeToggle = function() {
      // Do nothing on edit page to avoid error
      console.warn('themeToggle disabled on edit page');
    };
  }
</script>
@endsection