            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <form class="row g-3"
                        ...
                        {{-- Submit Button --}}
                        <div class="col-12">
                           @if(isset($bar) && $bar->id)    <a href="{{ route('admin.bar.edit', $bar->id) }}" class="btn btn-sm btn-primary">Edit</a>@else    <a href="{{ route('admin.bar.create') }}" class="btn btn-sm btn-primary">Add Bar</a>@endif
                        </div>
                    </form>
                </div>
            </div>
