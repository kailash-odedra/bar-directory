...
<head>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // If #themeToggle does not exist, prevent theme JS from running by removing its init call or skipping
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // Override themeToggle safely
        if (window.app && typeof window.app.themeToggle === "function") {
            const original = window.app.themeToggle;

            window.app.themeToggle = function() {
                if (!safe("#theme-toggle")) return;
                if (!safe("#darkModeSwitcher")) return;
                original();
            };
        }

        // Override overlay safely
        if (window.app && typeof window.app.overlay === "function") {
            const original = window.app.overlay;

            window.app.overlay = function() {
                if (!safe(".searchOverlay")) return;
                original();
            };
        }
