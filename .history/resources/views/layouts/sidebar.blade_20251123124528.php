...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu {{ ($catName === 'bars') ? 'active' : '' }}">
                <a href="#bars" data-bs-toggle="collapse" aria-expanded="{{ ($catName === 'bars') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg ... class="feather feather-bar-chart"></svg>
                        <span>Bars</span>
                    </div>
                    <div>
                ...
                <ul class="collapse submenu list-unstyled {{ ($catName === 'bars') ? 'show' : '' }}" id="bars" data-bs-parent="#accordionExample">
                    <li class="{{ Request::routeIs('bars.index') ? 'active' : '' }}">
                        <a href="{{ route('bars.index') }}"> Manage Bars </a>
                    </li>
                </ul>
            </li>
